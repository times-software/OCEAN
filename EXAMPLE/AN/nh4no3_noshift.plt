...
#    	System: Linux 2.6.18-274.3.1.el5
#    
...
set xlabel "Relative Energy (eV)" 0.000000,0.000000  font ""
set x2label "" 0.000000,0.000000  font ""
set xrange [ -28.0000 : -2.00000 ] noreverse nowriteback
set x2range [ * : * ] noreverse nowriteback  # (currently [-10.0000:10.0000] )
set ylabel "Intensity (arb. units)" 0.000000,0.000000  font ""
...
p 'CNBSE/abs.avg' w l lw 4, 'CNBSE/abs.avg.1' w l t 'NH_4' lw 4, 'CNBSE/abs.avg.2' w l t 'NO_3' lw 4
#    EOF
