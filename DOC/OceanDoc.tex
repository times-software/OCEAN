...
Read the excellent reviews by Kotani and Shin (Rev.\ Mod.\ Phys.\ {\bf 73}, 203, 2001) and Ament {\it et al.} (Rev.\ Mod.\ Phys.\ {\bf 83}, 705, 2011). With \program{ocean} we are able to calculate what Ament {\it et al.} refer to as direct RIXS. To be filled in later.

\subsection{Method}

The way we go about RIXS calculations with \program{ocean} is a two step process: one set of core-level calculations and one of valence. First, we carry out a core-level BSE calculation to determine the intermediate states.
