...
! $OMP PARALLEL DEFAULT( NONE ) &
! $OMP& SHARED( W, hp, re_bloch_state, im_bloch_state, p, sys, val_spin ) &
...
! $OMP& SHARED( k_chunk, W, hp, re_bloch_state, im_bloch_state, p, sys, val_spin, nthread, nthread2, jfft ) &
