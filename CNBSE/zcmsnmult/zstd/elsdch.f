...
c        array parameters as declared in the calling rtn
c        dimension statement.
c
c        n  is the order of the matrix  a=(ar,ai).
c
c        ar  and  ai  contain the Re and imaginary parts,
...
c
c        zr  and  zi  contain the Re and imaginary parts,
...
c
      ...
      go to 50
c
   10 call  elshtridi(nm,n,ar,ai,w,fv1,fv2,fm1)
      if (matz .ne. 0) go to 20
c     .......... find eigenvalues only ..........
      call  elstqlrat(n,w,fv2,ierr)
      go to 50
...
c
   ...
   40 continue
c
      call  elstql2(nm,n,w,fv1,zr,ierr)
      if (ierr .ne. 0) go to 50
      call  elshtribk(nm,n,ar,ai,fm1,n,zr,zi)
   50 return
      end
...
c     to a Re symmetric tridiagonal matrix using
...
c
c     calls elspythag for  dsqrt(a*a + b*b) .
c
c     questions and comments should be directed to burton s. garbow,
c     mathematics and computer science div, argonne national laboratory
c
...
c     Re symmetric tridiagonal matrix determined by  htridi.
c
c     on input
c
c        nm must be set to the row dimension of two-dimensional
...
c     is Re and that vector euclidean norms are preserved.
c
c     questions and comments should be directed to burton s. garbow,
c     mathematics and computer science div, argonne national laboratory
c
...
c
      if (m .eq. 0) go to 200
c     .......... transform the eigenvectors of the Re symmetric
...
c------------------------------------
      function elspythag(a,b)
      double precision a,b, elspythag
c
...
c
c     this rtn should function properly on all systems
